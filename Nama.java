...
public class Nama
{
    ...
    static void ubahNama(){
        JFrame frame = new JFrame();
        JLabel ubah = new JLabel("Masukkan Nama Baru");
        JLabel input = new JLabel("Masukkan Nama");
        JLabel kode = new JLabel("Masukkan Kode");
        JTextField txtnb = new JTextField();
        JTextField txtkode = new JTextField();
        JButton update = new JButton("Ubah Nama");
        ...
        update.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                koneksi.createStatement().executeUpdate("update Pembeli set nama_pembeli = '"+txtnb.getText()+"' where nobeli = "+txtkode.getText()+";");
