...
public class Jumlah
{
    ...
    static void ubahJumlah(){
        ...
        JLabel ubah = new JLabel("Masukkan Jumlah Pembelian Baru");
        JLabel input = new JLabel("Masukkan Jumlah");
        JLabel kode = new JLabel("Masukkan Kode");
        JTextField txtnb = new JTextField();
        JTextField txtkode = new JTextField();
        JButton update = new JButton("Ubah Jumlah");
        JButton kembali = new JButton("Kembali Ke Menu Utama");
        
        frame.setTitle("UBAH JUMLAH");
        ...
        update.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                koneksi.createStatement().executeUpdate("update Pembeli set jumlah_pembelian = '"+txtnb.getText()+"' where kode = "+txtkode.getText()+";");
