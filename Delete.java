...
public class Delete
{
    ...
    static void hapusData(){
        ...
        JButton nama = new JButton("Update Nama");
        ...
        barang.setBounds(50,170,180,20);
        harga.setBounds(50,200,180,20);
        jumlah.setBounds(50,230,180,20);
        ...
        delete.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                koneksi.createStatement().executeUpdate("Delete from Pembeli where nobeli = '"+txthapus.getText()+"';");
