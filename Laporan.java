...
public class Laporan
{
    ...
    static void Lapor(){
        JFrame jd = new JFrame ("Tabel Laporan");
        ...
        try {
            ...
            String sql = "SELECT Pembeli.nobeli, Barang.kodebrg, Barang.namabrg, Pembeli.harga, Pembeli.jumlah_pembelian " + "FROM Pembeli " + "INNER JOIN Barang ON Pembeli.kodebrg = Barang.kodebrg";
