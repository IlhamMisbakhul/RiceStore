    ...
    static void ubahBarang(){
        ...
        update.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                koneksi.createStatement().executeUpdate("update Pembeli set barang_yang_dibeli = '"+txtnb.getText()+"' where kode = "+txtkode.getText()+";");
